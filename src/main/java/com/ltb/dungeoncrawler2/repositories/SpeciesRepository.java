...
public interface SpeciesRepository extends JpaRepository<Species, Long> {
    ...
    @Query("SELECT DISTINCT s FROM Species s LEFT JOIN FETCH s.abilities WHERE s.name = :name")
    Optional<Species> findByNameWithAbilities(@Param("name") SpeciesName name);
}
